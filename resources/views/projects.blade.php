    ...
    <section class="portfolio" id="portfolio">
        <div class="container-fluid" style="padding: 0%;">
            <div class="row" style="padding: 0%; margin:0%;">
                ...
                <div class="gallery_product col p-0 col-sm-3 col-xs-6 filter category1">
                ...
                <div class="gallery_product col p-0 col-sm-3 col-xs-6 filter category2">
                ...
                <div class="gallery_product col p-0 col-sm-3 col-xs-6 filter category">
